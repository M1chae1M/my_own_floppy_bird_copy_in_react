My Flappy Bird copy
    ...
    In order to enter the scoreboard, you need to get a score in the top 10 of scores from local storage, or play a match when there are less than 10 records entered.
