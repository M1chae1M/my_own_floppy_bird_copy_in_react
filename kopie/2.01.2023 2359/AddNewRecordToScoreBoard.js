...
class AddNewRecordToScoreBoards extends React.Component{
    render(){
        ...
        const {aScore, show,reloadGame}=this.props;
        const actualDate=()=>{
            let data=new Date(),
            day=data.getDate(),
            month=data.getMonth(),
        ...
        return(
            <div id="AddNewRecordToScoreBoards" className={isVisible===true&&show===true?'':'hidden'} style={styles.AddNewRecordToScoreBoards}>
