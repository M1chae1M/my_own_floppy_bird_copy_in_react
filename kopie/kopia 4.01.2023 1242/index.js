...
class GameArea extends React.Component{
    ...
    render(){
        ...
        // const mapRender=()=>{
        //     for(let i=0;i<numberOfRenderedBlocks;i++){
        //         let arr=this.state.tableWithObjectsState;
        //         arr[i]=new BlockObject(randomNumber(minimumNumber));
        //         // tableWithObjectsState[i]=new BlockObject(randomNumber(minimumNumber));
        //     }
        //     firstRender=false;
        // }
        ...
        return(
            ...
            onLoad={()=>{
                this.setState({GameAreaHeight:document.querySelector('#GameArea').getBoundingClientRect().height})
            }}
            >
